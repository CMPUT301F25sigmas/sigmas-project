...
public class AdminProfileIntentTest {

    @Rule
    public ActivityScenarioRule<AdminProfilesActivity> activityRule = new ActivityScenarioRule<>(AdminProfilesActivity.class);
    ...
    public void testDropdown() {
        ...
        onView(withId(R.id.action_remove_user)).check(matches(isDisplayed()));
        onView(withId(R.id.action_view_details)).check(matches(isDisplayed()));

        onView(withId(R.id.action_view_details)).perform(click());

        intended(hasComponent(UserDetailsAdminActivity.class.getName()));
