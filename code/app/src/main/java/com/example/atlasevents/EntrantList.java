...
public class EntrantList implements Serializable {
    ...
    /**
     * Checks if the list contains an entrant with the given email.
     *
     * @param entrantEmail The email of the entrant to check for
     * @return {@code true} if the entrant is in the list, {@code false} otherwise
     */
     ...
     *
     * @return The number of entrants in the list
     */
    public int size(){
