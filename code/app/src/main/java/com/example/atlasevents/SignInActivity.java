...
public class SignInActivity extends AppCompatActivity {
     ...
     * <p>
     * Initializes repositories, session management, and determines whether the user
     * is already logged in. If a valid session exists, the user is redirected to the
     * corresponding dashboard. Otherwise, the sign-in interface is displayed.
     * </p>
     *
    ...
    private void signIn() {
        ...
        // Navigate to the sign-up activity when the "Join Now" text is clicked
        ...
        signInbutton.setOnClickListener(view -> {
            ...
            // Validate credentials against the repository
            userRepo.getUser(username, user -> {
                if (user != null) {
                    if (passwordHasher.checkPass(password, user.getPassword())) {
                        ...
                        if (user.getUserType().equals("Entrant")) {
