...
public class AdminImageIntentTest {

    @Rule
    public ActivityScenarioRule<AdminImagesActivity> activityRule = new ActivityScenarioRule<>(AdminImagesActivity.class);
    ...
    public void testDropdown() {
        ...
        onView(withId(R.id.action_remove_image)).check(matches(isDisplayed()));
        onView(withId(R.id.action_view_details)).check(matches(isDisplayed()));

        onView(withId(R.id.action_view_details)).perform(click());

        intended(hasComponent(ImageDetailsAdminActivity.class.getName()));
